...
<% String rentalSuccess = (String) session.getAttribute("rentalSuccess");
    if (rentalSuccess != null) { %>
<script>
    alert("<%= rentalSuccess %>"); // Hiển thị thông báo bằng hộp thoại alert
</script>
<% session.removeAttribute("rentalSuccess"); } %>
...
<style>
    ...
    .img-person1 {
        background-image: url("${profile.portrait}");
        width: 150px;
        height: 100px;
        float: left;
        background-size: cover;
    ...
    .img-person2 {
        background-image: url("${profile.portrait1}");
        width: 150px;
        height: 100px;
        float: left;
        background-size: cover;
    ...
    .img-person3 {
        background-image: url("${profile.portrait2}");
        width: 150px;
        height: 100px;
        float: left;
        background-size: cover;
            ...
            <div class="service-player">
                            <c:if test="${sessionScope.acc != null && sessionScope.acc.role.idRole == 3}">
                                ...
                                <div class="button-rent" style="padding-left: 5px">
                                    <button value="search" onclick="openModal()" style="height: 40px;
                                    margin-top: 10px;
                                    border-radius: 20px/20px;
                                    background-color: white;
                                    width: 100%;
...
<div id="first-modal">
    <form action="rent" method="POST">
        <div id="modal-table" class="modal">
            <div class="row-title">
                <button type="button" id="closeButton" onclick="closeModal()" class="close-button">x</button>
                <h2>Rent player</h2>
            </div>
            <div class="modal-body">
                <div class="form-row" style="display: none">
                    ...
                    <div class="div-4">
                        <span id="idPlayer">${profile.account_id}</span>
                        <input type="hidden" name="idPlayer" value="${profile.account_id}"> <!-- Hidden input to send player name -->
                    </div>
                </div >
                <div class="form-row">
                    <div class="div-6">
                    ...
                    <div class="div-4">
                        ...
                        <input type="hidden" name="playerName" value="${profile.fullName}"> <!-- Hidden input to send player name -->
                    </div>
                </div>
                <div class="form-row">
                    <div class="div-6">
                    ...
                    <div class="div-4">
                        <select id="hour-select" name="rentalHours" style="padding: 10px;
  background: pink;
  border: none;">
                ...
                <div class="form-row">
                    ...
                    <div class="div-4">
                        <span id="price">${profile.price}.000k </span>
                        <input type="hidden" name="totalAmount" id="rentalPrice" value="${profile.price}.000k"> <!-- Hidden input for price -->
                    </div>
                </div>
                <div class="form-row">
                    <div class="div-6">
  ...
  border-radius: 5px;">Rent</button>
            ...
            <script>
                ...
                // Lắng nghe sự thay đổi của danh sách chọn giờ
                document.getElementById("hour-select").addEventListener("change", updatePrice);
