...
<div class="containers">
    ...
    <nav class="sticky-nav" style="background: #FFE4E1">
  ...
  text-align: center;" for="online">Online</label>
            ...
            <div class="content">
                ...
                <div class="img1"
                     style="width: 100% ;height: 650px;margin-top: 20px;padding-top: 30px;padding-left: 10px;padding-right: 20px;border-radius: 10px">
  ...
  display: inline-block;"></span>
                ...
                <div class="img2"
                     style="width: 100% ;height: 940px;margin-top: 20px;padding-top: 30px;padding-left: 10px;padding-right: 20px;border-radius: 10px">
                    <div class="grid-container">
  ...
  display: inline-block;"></span>
                ...
                <div class="front">
                    <b style="font-size: 20px;color:deeppink">NEW PLAYERS </b>
                </div>
                <div class="img4"
                     style="width: 100% ;height: 940px; margin-top: 20px;padding-top: 30px;padding-left: 10px;padding-right: 20px;border-radius: 10px">
                    <div class="grid-container">
  ...
  display: inline-block;"></span>
                ...
                <c:if test="${sessionScope.acc.accountDetail.gender == 'Women'}">
                    <div class="front">
                        <b style="font-size: 20px;color:deeppink">MALE PLAYERS </b>
                    </div>
                    <div class="img5"
                         style="width: 100% ;height: 940px; margin-top: 20px;padding-top: 30px;padding-left: 10px;padding-right: 20px;">
                        <div class="grid-container">
  ...
  display: inline-block;"></span>
                ...
                <c:if test="${sessionScope.acc.accountDetail.gender == 'Man'}">
                    <div class="front">
                        <b style="font-size: 20px;color:deeppink"> FEMALE PLAYERS </b>
                    </div>
                    <div class="img6"
                         style="width: 100% ;height: 940px;margin-top: 20px;padding-top: 30px;padding-left: 10px;padding-right: 20px;border-radius: 10px">
                        <div class="grid-container">
...
<div class="front">
                        <b style="font-size: 20px;color:deeppink"> PLAYERS AROUND YOU </b>
                    </div>
                    <div class="img6"
                         style="width: 100% ;height: 940px;margin-top: 20px;padding-top: 30px;padding-left: 10px;padding-right: 20px;border-radius: 10px;">
                        <div class="grid-container">
  ...
  display: inline-block;"></span>
                                        ...
                                        <div class="imgUser"
                                            ...
                                            <div class="address" style="color:limegreen;">
                                                ...
                                                <span><b style="color: #3f3a3a;font-size: 11px">${address.city}</b></span>
