...
<div class="containers">
  ...
  text-align: center;" for="online">Online</label>
      ...
      <div class="content">
        ...
        <div class="img1" style="width: 100% ;height: 650px; background-color: pink;margin-top: 20px;padding-top: 30px;padding-left: 20px;padding-right: 20px;border-radius: 10px">
          <div class="box"
            ...
            <div class="imgPlayer" style="width: 210px; height: 200px;">
              <a href="/project?action=add&id=${list.getId()}"
                ...
                <button type="button" value="display"
                        style="position: absolute; bottom: 10px; right: 10px; width: 90px; height: 28px; border-radius: 15px/15px; background-color: deeppink;"></button>
              </a>
            </div>
            <div class="info"
  ...
  display: inline-block;"></span>
          ...
          <div class="box"
               style="width: 210px; height: 280px ; background-color: white; margin-left: 30px; float: left;border-radius: 10px;overflow: hidden">
            ...
            <div class="imgPlayer" style="width: 210px; height: 200px;">
              <a href="/project?action=add&id=${list.getId()}"
                ...
                <img src="laplace-m-vung-dat-gio-01-06-2021-0.png"
                     style="max-width: 100%; height: 200px;">
                <button type="button" value="display"
                        style="position: absolute; bottom: 10px; right: 10px; width: 90px; height: 28px; border-radius: 15px/15px; background-color: #dc3545;"></button>
              </a>
            </div>
            <div class="info"
                 style="display: flex; justify-content: space-between; align-items: center; padding: 0 10px;">
  ...
  display: inline-block;"></span>
            ...
            <div class="imgUser"
                 style="width: 190px; height: 25px; display: flex; justify-content: space-between;padding-left: 5px;">
              <div style="display: flex;">
  ...
  display: inline-block;"></span>
          ...
          <div class="box"
               style="width: 210px; height: 280px ; background-color: white; margin-left: 15px; margin-top:30px;float: left;border-radius: 10px;overflow: hidden">
  ...
  display: inline-block;"></span>
          ...
          <div class="box"
               style="width: 210px; height: 280px ; background-color: white; margin-left: 30px; margin-top:30px;float: left;border-radius: 10px;overflow: hidden">
  ...
  display: inline-block;"></span>
        ...
        <div class="front-end">
          <b style="font-size: 20px;color:deeppink">MOST RENTED</b>
        </div>
        <div class="img2" style="width: 100% ;height: 960px; background-color: pink;margin-top: 20px;padding-top: 30px;padding-left: 20px;padding-right: 20px;border-radius: 10px">
          <div class="box"
               style="width: 210px; height: 280px; background-color: white;float: left;margin-left: 15px;  border-radius: 10px; overflow: hidden;">
            <div class="imgPlayer" style="width: 210px; height: 200px;">
              <a href="/project?action=add&id=${list.getId()}"
  ...
  display: inline-block;"></span>
            ...
            <div class="imgUser"
              ...
              <div class="dollar" style="color:violet;">
                <i style="font-size: 20px" class="fa-solid fa-circle-dollar-to-slot fa-beat"></i>
                <span><b style="color: #3f3a3a">5</b></span>
              </div>
            </div>
          </div>
  ...
  display: inline-block;"></span>
        ...
        <div class="front-end">
          <b style="font-size: 20px;color:deeppink">NEWBIE PLAYERS</b>
        </div>
        <div class="img3" style="width: 100% ;height: 960px; background-color: pink;margin-top: 20px;padding-top: 30px;padding-left: 20px;padding-right: 20px;border-radius: 10px">
          <div class="box"
               style="width: 210px; height: 280px; background-color: white;float: left;margin-left: 15px;  border-radius: 10px; overflow: hidden;">
            <div class="imgPlayer" style="width: 210px; height: 200px;">
              <a href="/project?action=add&id=${list.getId()}"
  ...
  display: inline-block;"></span>
            ...
            <div class="imgUser"
              ...
              <div class="new" style="color:deepskyblue;">
                <i style="font-size: 20px"class="fa-regular fa-user fa-beat"></i>
                <span><b style="color: #3f3a3a">5</b></span>
              </div>
            </div>
          </div>
  ...
  display: inline-block;"></span>
        ...
        <div class="img4" style="width: 100% ;height: 960px; background-color: pink;margin-top: 20px;padding-top: 30px;padding-left: 20px;padding-right: 20px;border-radius: 10px">
          <div class="box"
               style="width: 210px; height: 280px; background-color: white;float: left;margin-left: 15px;  border-radius: 10px; overflow: hidden;">
            <div class="imgPlayer" style="width: 210px; height: 200px;">
              <a href="/project?action=add&id=${list.getId()}"
  ...
  display: inline-block;"></span>
            ...
            <div class="imgUser"
              ...
              <div class="fire" style="color:orangered;">
                <i style="font-size: 20px"  class="fa-solid fa-fire-flame-curved fa-beat"></i>
                <span><b style="color: #3f3a3a">5</b></span>
              </div>
            </div>
          </div>
