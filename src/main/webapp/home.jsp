...
<div class="containers">
  ...
  text-align: center;" for="online">Online</label>
      ...
      <div class="content">
        ...
        <div class="img1" style="width: 100% ;height: 650px; background-color: pink;margin-top: 20px;padding-top: 30px;padding-left: 20px;padding-right: 20px;border-radius: 10px">        <div class="grid-container">
              ...
              <div class="box"
                ...
                <div class="imgPlayer" style="width: 210px; height: 200px;">
                  <a href="/project?action=add&id="
                    ...
                    <img src="file:///C:/Users/hieuh/Pictures/Screenshots/Screenshot%202023-10-17%20084958.png"
  ...
  display: inline-block;"></span>
                ...
                <div class="imgUser"
                  ...
                  <div class="star" style="color:yellow;">
                    ...
                    <span><b style="color: #3f3a3a">${o.numberOfRentals}</b></span>
                  </div>
                </div>
              </div>
