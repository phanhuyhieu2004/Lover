...
<footer style="margin-top: 30px",>
    <div class="footer"style="height: 100px;padding-top: 20px;">
        ...
        <ul class="socials">
            <li><a href="#" style="background-color: #4267B2;

  color: white;"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#" style="background-color: dodgerblue;
  color: white;
"><i class="fa fa-twitter"></i></a></li>
            <li><a href="#" style="background-color: black;
  color: white;
 "><i class="fa fa-github"></i></a></li>
            <li><a href="#" style="background-color:red;
