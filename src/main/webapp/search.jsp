...
<div class="containers">
    ...
    <nav class="sticky-nav" style="background: pink">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach items="${listAccountDetail}" var="o">
                                    <div class="grid-item">
                                        <div class="box"
                                             style="width: 210px; height: 280px; background-color: white;float: left;margin-left: 15px;  border-radius: 10px; overflow: hidden;border: 0.1rem solid hotpink;">
